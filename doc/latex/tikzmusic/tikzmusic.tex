...
\usepackage{fontspec}
\setmonofont[Scale=0.8]{MesloLGS-Regular.ttf}[
...
\pgfkeys{
  /pdflinks/search key prefixes in={/tikz/,/pgf/,/tm/},
...
% Resize it a bit
\let\oldtmlinei\tmline%
\def\tmline{\begin{minipage}{\linewidth-5mm}\oldtmlinei}%
\let\oldendtmlinei\endtmline%
\def\endtmline{\oldendtmlinei\end{minipage}}%
