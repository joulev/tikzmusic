...
\begin{tmstaff}{g}{}
  ...
  \tmquarter{7}{C4}{a}\tmquarter{9}{D4}{b}
  \tmslur[amplitude=1.5mm,start yshift=-1mm,end shift={(-1mm,-1mm)}]{a}{b}
\end{tmstaff}
\end{tmline}
\end{codeexample}
\begin{command}{\tmslur*\opt{\oarg{options}}\marg{note 1}\oarg{shift 2}\marg{note 2}}
...
\end{tmline}
\end{codeexample}
\begin{command}{\tmslurline\opt{\oarg{options}}\marg{coordinate 1}\marg{coordinate 2}}
...
\end{command}
You can use these two commands to tie two notes as follows. It is how |\tmtie| is
currently working.
\begin{codeexample}[]
\begin{tmline}
\begin{tmstaff}{g}{}
  \tmquarter{4}{C4,E4,G4}{a}\tmquarter{7}{C4,E4,G4}{b}
  \tmslurline[amplitude=1.5mm,start shift={(2mm,-1.5mm)},end shift={(-2mm,-1.5mm)}]{a-C4}{b-C4}
  \tmslurline[amplitude=1.5mm,start shift={(2mm,-1.5mm)},end shift={(-2mm,-1.5mm)}]{a-E4}{b-E4}
  \tmslurline*[amplitude=1.5mm,start shift={(2mm,1.5mm)},end shift={(-2mm, 1.5mm)}]{a-G4}{b-G4}
\end{tmstaff}
\end{tmline}
\end{codeexample}
...
\begin{tmstaff}{g}{}
  ...
  \tmquarter{6}{C5}{a} \tmquarter{8}{D5}{b} \tmcrescendo[yshift=-5mm]{a}{b}
  \tmquarter{10}{C5}{a}\tmquarter{12}{D5}{b}\tmcrescendo[cresc dim sep=5mm]{a}{b}
\end{tmstaff}
\end{tmline}
\end{codeexample}
\begin{command}{\tmcrescendo*\opt{\oarg{options}}\marg{note 1}\marg{note 2}}
...
\end{tmline}
\end{codeexample}
\begin{command}{\tmcrescendoline\opt{\oarg{options}}\marg{coordinate 1}\marg{coordinate 2}}
...
\end{command}
\begin{command}{\tmdiminuendoline\opt{\oarg{options}}\marg{coordinate 1}\marg{coordinate 2}}
...
\end{tmline}
\end{codeexample}
\begin{command}{\tmvoltaline\opt{\oarg{options}}\marg{coordinate 1}\marg{coordinate 2}\marg{number}}
  Draw a \emph{closed} volta line between \meta{coordinate 1} and \meta{coordinate 2}.
\end{command}
\begin{command}{\tmvoltaline*\opt{\oarg{options}}\marg{coordinate 1}\marg{coordinate 2}\marg{number}}
...
\begin{tmline}
  \begin{tmstaff}{g}{}
    ...
    \tmvoltaline{4.1,1}{7.9,1}{1}\tmvoltaline*{8.1,1}{10.5,1}{2}
  \end{tmstaff}
\end{tmline}
\end{codeexample}
...
\end{tmline}
\end{codeexample}
\begin{command}{\tmoctaveline\opt{\oarg{options}}\marg{coordinate 1}\marg{coordinate 2}\marg{type}}
...
\end{tmline}
\end{codeexample}
\begin{command}{\tmpedalline\opt{\oarg{options}}\marg{coordinate 1}\marg{coordinate 2}}
