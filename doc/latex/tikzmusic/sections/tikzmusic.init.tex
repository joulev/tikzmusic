...
\let\oldtmlineii\tmline%
\def\tmline{\begin{minipage}{\linewidth+5mm}\oldtmlineii}%
\let\oldendtmlineii\endtmline%
\def\endtmline{\oldendtmlineii\end{minipage}}%
\begin{codeexample}[]
\begin{minipage}{4cm}
\begin{tmline}
\begin{tmstaff}{g}{}\end{tmstaff}
...
\end{minipage}
\end{codeexample}
\let\oldtmlineiii\tmline%
\def\tmline{\begin{minipage}{\linewidth-5mm}\oldtmlineiii}%
\let\oldendtmlineiii\endtmline%
\def\endtmline{\oldendtmlineiii\end{minipage}}%
