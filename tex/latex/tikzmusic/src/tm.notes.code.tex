...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% SOME EXTRA STUFFS
\newcommand\tmappendaccidental[4][0pt]{\pic[color/.expanded=\tm@color,xshift=#1] at ([xshift=-3mm]#2-#3) {tm-#4};}
...
\newcommand\tm@@adddot[4][0pt]{
  ...
  \foreach \tm@i in {1,...,#4} {
    \fill[color/.expanded=\tm@color,xshift=#1] 
...
\newcommand\tmwhole[4][]{
  \foreach \tm@i in {#3} {
    ...
    \pgfmathtruncatemacro\tm@note@diff{\tm@note@getnumber@result-\tm@note@mid@clef}
    \tmset{#1}
    \tm@whole[\tm@note@relativepos]{#2}{\tm@note@diff}
...
\newcommand\tmwholerest[2][]{
  \begingroup
    \tmset{#1}
    \fill[color/.expanded=\tm@color,shift={(0,\tm@lineshift*.1)}] (#2-.125,.08) rectangle ++ (.25,.12);
    \draw[color/.expanded=\tm@linecolor,shift={(0,\tm@lineshift*.1)}] (#2-.2,.2) -- ++ (.4,0);
  \endgroup
}
\newcommand\tmhalfrest[2][]{
  \begingroup
    \tmset{#1}
    \fill[color/.expanded=\tm@color,shift={(0,\tm@lineshift*.1)}] (#2-.125,0) rectangle ++ (.25,.12);
    \draw[color/.expanded=\tm@linecolor,shift={(0,\tm@lineshift*.1)}] (#2-.2,0) -- ++ (.4,0);
  \endgroup
}
\newcommand\tmquarterrest[2][]{
  \begingroup
    \tmset{#1}
    \pic[color/.expanded=\tm@color] at (#2,\tm@lineshift*.1) {tm-quarter-note-rest};
  \endgroup
}
\newcommand\tmbelowquarterrest[3][]{
  \begingroup
    \tmset{#1}
    \pic[color/.expanded=\tm@color] at (#2,\tm@lineshift*.1) {tm-#3-note-rest};
  \endgroup
}
