...
\newcommand\tm@adddot[3][]{\tm@@adddot[#1]{#2}{#3}{1}}
...
\newcommand\tm@head[5][center]{
  ...
  \pgfmathparse{\tm@note@max@diff}
  \global\@nameedef{tm@note@\detokenize{#4}@max}{\pgfmathresult}
  \pgfmathparse{\tm@note@min@diff}
  \global\@nameedef{tm@note@\detokenize{#4}@min}{\pgfmathresult}
  \pgfmathparse{\tm@note@average@diff}
  \global\@nameedef{tm@note@\detokenize{#4}@avg}{\pgfmathresult}
  \global\@nameedef{tm@note@\detokenize{#4}@pos}{#2}
  \global\@nameedef{tm@note@\detokenize{#4}@clr}{\tm@color}
  \ifstrequal{#5}{whole}{\coordinate (#4-tail) at (#2,.1*\tm@note@max@diff);}{}
}
...
\newcommand\tm@half[4][]{
  \begingroup
    ...
    \expandafter\ifstrequal\expandafter{\tm@note@relativepos}{center}{
      \ifdim\tm@note@average@diff pt<0pt
        \draw[xshift=#2cm,color/.expanded=\tm@color] 
          (\tm@notewidth,.1*\tm@note@min@diff) -- 
          ([yshift=\tm@notelength]\tm@notewidth,.1*\tm@note@max@diff) coordinate (#4-tail);
      \else
        \draw[xshift=#2cm,color/.expanded=\tm@color] 
          (-\tm@notewidth,.1*\tm@note@max@diff) -- 
          ([yshift=-\tm@notelength]-\tm@notewidth,.1*\tm@note@min@diff) coordinate (#4-tail);
      \fi
    }{}
  \endgroup
  \def\tm@note@average@diff{0}
  ...
  \begingroup
    ...
    \expandafter\ifstrequal\expandafter{\tm@note@relativepos}{center}{
      \ifdim\tm@note@average@diff pt<0pt
        \draw[xshift=#2cm,color/.expanded=\tm@color] 
          (\tm@notewidth,.1*\tm@note@min@diff) -- 
          ([yshift=\tm@notelength]\tm@notewidth,.1*\tm@note@max@diff) coordinate (#5-tail);
        \tm@insert@flag@up{#5}{#4}
      \else
        \draw[xshift=#2cm,color/.expanded=\tm@color] 
          (-\tm@notewidth,.1*\tm@note@max@diff) -- 
          ([yshift=-\tm@notelength]-\tm@notewidth,.1*\tm@note@min@diff) coordinate (#5-tail);
