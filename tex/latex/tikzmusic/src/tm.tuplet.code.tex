  ...
  \begingroup
    ...
    \iftm@reversed
      ...
      \draw[color/.expanded=\tm@color] 
        ([xshift=-1.5mm,yshift=-2mm]tm@tuplets@aux1min) -- ++ (0,-.2) coordinate (tm@tuplets@aux1)
        ([xshift= 1.5mm,yshift=-2mm]tm@tuplets@aux2min) -- ++ (0,-.2) coordinate (tm@tuplets@aux2);
      \draw[color/.expanded=\tm@color] (tm@tuplets@aux1) -- (tm@tuplets@number) -- (tm@tuplets@aux2);
    \else
      ...
      \draw[color/.expanded=\tm@color] 
        ([xshift=-1.5mm,yshift=2mm]tm@tuplets@aux1max) -- ++ (0,.2) coordinate (tm@tuplets@aux1)
        ([xshift= 1.5mm,yshift=2mm]tm@tuplets@aux2max) -- ++ (0,.2) coordinate (tm@tuplets@aux2);
      \draw[color/.expanded=\tm@color] (tm@tuplets@aux1) -- (tm@tuplets@number) -- (tm@tuplets@aux2);
    \fi
  \endgroup
}